...
int main(int argc, char **argv) 
{
    ...
    dataPreprocessPtr.reset(new DataPreprocess(params, node));
    ...
    sortPatternCenters(lidar_center_cloud, lidar_centers, "lidar", params.lidar_flip_yz);
    canonicalizePatternOrder(qr_centers, params.delta_width_circles, params.delta_height_circles);
    canonicalizePatternOrder(lidar_centers, params.delta_width_circles, params.delta_height_circles);
